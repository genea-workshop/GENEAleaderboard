import"../chunks/DsnmJJEf.js";import"../chunks/ByIFj6Va.js";import{f as r,a as t}from"../chunks/Cwqn2CMJ.js";var o=r(`<main class="subcontainer"><div class="home-split-ver"><div class="home-text card"><h1 class="h1">Last blog post goes here</h1> <p class="lead">Welcome to the <strong>GENEA Leaderboard</strong> project!  
        ...
        more open, transparent, and comparable across projects.</p></div> <div class="home-text card"><h1 class="h1">Second blog post goes here</h1> <p class="lead">Welcome to the <strong>GENEA Leaderboard</strong> project!  
        This platform provides a unified evaluation hub for gesture generation and animation research.
        Here you can explore state-of-the-art models, compare team results, and discover available datasets
        ...
        more open, transparent, and comparable across projects.</p></div> <div class="home-text card"><h1 class="h1">First blog post goes here</h1> <p class="lead">Welcome to the <strong>GENEA Leaderboard</strong> project!  
        This platform provides a unified evaluation hub for gesture generation and animation research.
        Here you can explore state-of-the-art models, compare team results, and discover available datasets
        ...
        more open, transparent, and comparable across projects.</p></div></div></main>`);function l(e){var a=o();t(e,a)}export{l as component};
